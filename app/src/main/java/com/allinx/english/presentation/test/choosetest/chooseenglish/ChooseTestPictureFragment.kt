...
import com.allinx.english.databinding.FragmentChooseTestPictureBinding
import com.allinx.english.extension.hideLoading
import com.allinx.english.extension.navigateBack
import com.allinx.english.extension.openFinishFromChooseTestPictureScreen
import com.allinx.english.extension.showLoading
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class ChooseTestPictureFragment : Fragment() {

    private lateinit var binding: FragmentChooseTestPictureBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentChooseTestPictureBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    private fun updateUI(){
        if (position >= listQuestions.size){
            openFinishFromChooseTestPictureScreen(right,wrong)
        }
        else{
            with(binding) {
                ...
                imgChooseTestWord.load(listQuestions[position].word.image)
    ...
    companion object {
        @JvmStatic
        fun newInstance() = ChooseTestPictureFragment()
    }
}