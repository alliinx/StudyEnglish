...
import com.allinx.english.extension.openFinishFromChooseTestTextRussianScreen
import com.allinx.english.extension.showLoading
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class ChooseTestTextRussianFragment : Fragment() {
    ...
    private fun updateUI(){
        if (position >= listQuestions.size){
            openFinishFromChooseTestTextRussianScreen(right,wrong)
        }
        else{
            with(binding) {
                ...
                wordChooseTest.text = listQuestions[position].word.word
    ...
    private fun checkAnswer(answer: String): Boolean {
        return answer == listQuestions[position].word.meaning
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = ChooseTestTextRussianFragment()
    }
}